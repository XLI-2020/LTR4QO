...
def create_model(LossFunction, **kwargs):
    class ModelInterface(LossFunction):
        ...
        def __init__(self, epochs=251, sample_size=10, batch_size=64, name="", folder="", **kwargs):
        ...
        def fit(self, X_train_vecs, X_train_tree, y_train, X_valid_vecs, X_valid_trees, y_valid,  use_presort=False,
            ...
            for epoch in range(self.epochs):
                ...
                total_curr_job_numbers = get_the_split_of_jobs_list(job_numbers, train_ratio=0.5)
                ...
                for batch_i in range(num_batches):
                    ...
                    for curr_sample_size in sample_size_list:
                        ...
                        train_ndcg_epoch.append(train_ndcg_value.mean().item())
                ...
                with torch.no_grad():
                    ...
                    valid_ndcg_es.append(valid_ndcg.mean().item())
