...
def get_the_split_of_jobs_list(jobs_list, valid_ratio):
    '''
...
def create_model(LossFunction, **kwargs):
    class ModelInterface(LossFunction):
        ...
        def test_loss_function(self):
            pred_results = torch.tensor([[43, 343, 654]])
            curr_y = torch.tensor([[5, 5, 3]])
        ...
        def fit(self, X_train_vecs, X_train_tree, y_train, X_test_vecs, X_test_trees, y_test, use_presort=False,
            ...
            for epoch in range(self.epochs):
                ...
                curr_job_numbers = get_the_split_of_jobs_list(job_numbers, valid_ratio=0.2)

                print('length of curr_job_numbers: ', len(curr_job_numbers))
