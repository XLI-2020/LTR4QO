...
class EnumerationNode:
    ...
    def normalize_query(self, workload):
        if 'tpch' in workload or "Db" in workload:
            ...
            max_vec = np.array([1.0, 1.0, 23.0, 1, 6.001215e+06, 6.001215e+06]) # transfer so unified 23.0
            ...
            max_vec = np.array([1.0, 1.0, 23.0, 1.0, 328064, 328064]) # transfer so unified 23.0
