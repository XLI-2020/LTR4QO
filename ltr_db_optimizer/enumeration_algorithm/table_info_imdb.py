...
class IMDBTableInformation:
    schema = "dbo"
    database = "imdb" 
    # ["aka_name", "aka_title", "cast_info", "char_name", "comp_cast_type", "company_name", "company_type", "complete_cast", "info_type", "keyword", "kind_type", ]
...
# imdb = IMDBTableInformation()
# print(list(imdb.matcher.keys()))