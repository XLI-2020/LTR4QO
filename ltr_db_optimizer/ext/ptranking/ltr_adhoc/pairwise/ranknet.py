...
from ltr_db_optimizer.ext.ptranking.base.adhoc_ranker import AdhocNeuralRanker
from ltr_db_optimizer.ext.ptranking.ltr_adhoc.eval.parameter import ModelParameter
from ltr_db_optimizer.ext.ptranking.ltr_adhoc.util.lambda_utils import get_pairwise_comp_probs
...
class RankNet(AdhocNeuralRanker):
    ...
    def custom_loss_function(self, batch_preds, batch_std_labels, train=True, **kwargs):
        '''
